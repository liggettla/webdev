...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{<}\ExtensionTok{form}\NormalTok{ onsubmit=}\StringTok{"return false"}\OperatorTok{>}
\OperatorTok{<}\ExtensionTok{form}\NormalTok{ onsubmit=}\StringTok{"return getUsername()"}\OperatorTok{>}
\end{Highlighting}
\end{Shaded}
